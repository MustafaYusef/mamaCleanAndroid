...
class PackageCartAdapter(
    val context: Context,
    val response: List<PackageOrder>,
    val viewModel: CartViewModel
) : RecyclerView.Adapter<PackageCartAdapter.CustomViewHolder>(){
//
 // private  var mOnNotlesener=onNoteLisener
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
      //  holder.view.containerCar.startAnimation(AnimationUtils.loadAnimation(context, R.anim.zoom_in))
        ...
        holder.view.cartType.visibility=View.GONE
        ...
        holder.view.ItemCartPrice.visibility=View.GONE
        ...
        holder.view.deleteFromCart?.setOnClickListener {
            ...
            dview.conform?.setOnClickListener {
                data.Item_id?.let { it1 -> viewModel.DeleteByIdCartPackage(it1) }
                malert?.dismiss()
            }
