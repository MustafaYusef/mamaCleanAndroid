...
class EditeProfile : Fragment(),ProfileLesener {
    ...
    override fun OnSuccessEditeProfile(message: reSendRes) {
        ...
        context?.toast(context?.resources!!.getString(R.string.updateInfo))
    ...
    override fun OnSuccessUpdatePhoto(message: reSendRes) {
        context?.toast(context?.resources!!.getString(R.string.updatePhoto))
        viewModel?.UpdateProfile(MainActivity.cacheObj.token,userNameEditeProf?.text.toString(),
            cityId)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        imagesBodyRequest=null
        imagePath=""
        userNameEditeProf?.setText(arguments?.getString("name"))
        locEditeProfile?.setText(arguments?.getString("city"))
        ...
        locEditeProfile?.setOnClickListener {
            viewModel?.getCity()
        }
    ...
    fun ShowCity(
        ...
        dview.applayFilter.setOnClickListener {
            ...
            locEditeProfile.setText(resCity?.get(index)?.name)
