...
class DetailsOrderAdapter(
    val context: Context,
    val response: categoryOrderDetailsRes
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
      //  holder.view.containerCar.startAnimation(AnimationUtils.loadAnimation(context, R.anim.zoom_in))
        ...
        if(Locale.getDefault().getLanguage()=="ar") {
            ...
            holder.view.titleOrderItem.text=data.item.name_en
        }

        holder.view. countOrderItem.text=context?.resources!!.getString(R.string.num)+data.count.toString()


        Glide.with(context).load(MainActivity.constant.base+
